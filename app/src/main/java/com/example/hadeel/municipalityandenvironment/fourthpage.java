    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TimePickerDialog timepick = new TimePickerDialog(fourthpage.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        txtDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datepicker= new DatePickerDialog(fourthpage.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
